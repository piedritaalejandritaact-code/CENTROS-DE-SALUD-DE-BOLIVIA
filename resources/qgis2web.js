...
map.getView().fit([-8138488.768346, -2653046.326441, -6030542.556191, -1084346.817752], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Centros de salud de  Bolivia</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (32 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'centros de salud de toda bolivia';
            }
